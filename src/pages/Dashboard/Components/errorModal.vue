  ...
  <div>
      ...
      <modal v-if="errorModal" @close="errorModal = false">
        ...
        <template slot="footer">
          <router-link :to="{path:'/dashboard'}"><md-button class="md-simple">Ir al inicio</md-button></router-link>
...
import {Modal} from '@/components'
  ...
  methods:{
    logout(){
     this.$store.dispatch('users/logout').then(res => { this.$router.push('/'); });
    }
  }
  }
</script>
